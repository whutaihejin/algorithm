...
public class P23 {
    ...
    public void minHeapify(ListNode[] lists, int i, int size) {
        while (i < size) {
            int smallest = i;
            int left = (i << 1) + 1;
            int right = left + 1;
            if (left < size && (lists[left] != null && (lists[smallest] == null || lists[left].val < lists[smallest].val))) {
                smallest = left;
            }
            if (right < size && (lists[right] != null && (lists[smallest] == null || lists[right].val < lists[smallest].val))) {
                smallest = right;
            }
            if (smallest != i) {
    ...
    public static ListNode mergeKLists2(ListNode[] lists) {
        ...
        for (;;) {
            ...
            for (int k = 0; k < lists.length; k++) {
                if (min == null || (lists[k] != null && lists[k].val < min.val)) {
                    min = lists[k];
                    minIndex = k;
                }
            }
            if (min == null) {
                ...
                ListNode q = new ListNode(min.val);
                p.next = q;
                p = q;
            } else {
    ...
    @Test
    public void minHeapifyTest0() {
        ListNode[] lists = {};
        minHeapify(lists, 0, lists.length);
    }

    @Test
    public void minHeapifyTest1() {
    ...
    @Test
    public void minHeapify2() {
        ListNode n1 = new ListNode(1);
        ListNode n2 = new ListNode(2);
        ListNode[] lists = {n2, n1};
        minHeapify(lists, 0, lists.length);
    }

    @Test
    public void minHeapify3() {
        ListNode n1 = new ListNode(1);
        ListNode n2 = new ListNode(2);
        ListNode n3 = new ListNode(3);
        ListNode[] lists = {n3, n2, n1};
        minHeapify(lists, 0, lists.length);
    }
    ...
    public void minHeapify4() {
        ...
        ListNode n2 = new ListNode(2);
        ListNode n3 = new ListNode(3);
        ListNode[] lists = {n3, n1, n2};
        minHeapify(lists, 0, lists.length);
    }

    @Test
    public void minHeapify5() {
        ListNode n1 = new ListNode(1);
        ListNode n2 = new ListNode(2);
        ListNode n3 = new ListNode(3);
        ListNode[] lists = {null, n1, n2};
        minHeapify(lists, 0, lists.length);
        Assert.assertEquals(lists[0], n1);
    }

    @Test
    public void minHeapify6() {
        ListNode n1 = new ListNode(1);
        ListNode n2 = new ListNode(2);
        ListNode n3 = new ListNode(3);
        ListNode[] lists = {n3, null, n1};
        minHeapify(lists, 0, lists.length);
        Assert.assertEquals(lists[0], n1);
    }

    @Test
    public void minHeapify7() {
        ListNode n1 = new ListNode(1);
        ListNode n2 = new ListNode(2);
        ListNode n3 = new ListNode(3);
        ListNode[] lists = {n3, null, null};
        minHeapify(lists, 0, lists.length);
        Assert.assertEquals(lists[0], n3);
    }
    ...
    public void doTest1() {
        ...
        ListNode k5 = new ListNode(15, null);
        ListNode k4 = new ListNode(14, k5);
        ListNode k3 = new ListNode(13, k4);
        ListNode k2 = new ListNode(12, k3);
        ListNode l3 = new ListNode(11, k2);

//        System.out.println(mergeKLists(new ListNode[]{null}));
//        System.out.println(mergeKLists(new ListNode[]{null, null}));
//        System.out.println(mergeKLists(new ListNode[]{null, null, null}));
//        System.out.println(mergeKLists(new ListNode[]{l1}));
//        System.out.println(mergeKLists(new ListNode[]{l1, l2}));
//        System.out.println(mergeKLists(new ListNode[]{l1, null}));
//        System.out.println(mergeKLists(new ListNode[]{null, l2}));
//        System.out.println(mergeKLists(new ListNode[]{l1, l2, null}));
        System.out.println(mergeKLists(new ListNode[]{l1, l2, l3}));
    }

    @Test
    public void doTest2() {
        ListNode n5 = new ListNode(15, null);
        ListNode n4 = new ListNode(12, n5);
        ListNode n3 = new ListNode(9, n4);
        ListNode n2 = new ListNode(6, n3);
        ListNode l1 = new ListNode(3, n2);

        ListNode m5 = new ListNode(14, null);
        ListNode m4 = new ListNode(11, m5);
        ListNode m3 = new ListNode(8, m4);
        ListNode m2 = new ListNode(5, m3);
        ListNode l2 = new ListNode(2, m2);

        ListNode k5 = new ListNode(13, null);
        ListNode k4 = new ListNode(10, k5);
        ListNode k3 = new ListNode(7, k4);
        ListNode k2 = new ListNode(4, k3);
        ListNode l3 = new ListNode(1, k2);
        System.out.println(mergeKLists(new ListNode[] {l1, l2, l3}));
    }
    ...
    public void doTest3() {
        ...
        ListNode k2 = new ListNode(4, k3);
        ListNode l3 = new ListNode(1, k2);
        System.out.println(mergeKLists(new ListNode[] {null, l1, l3}));
    }
    ...
    public void doTest4() {
        ...
        ListNode k2 = new ListNode(4, k3);
        ListNode l3 = new ListNode(1, k2);
        System.out.println(mergeKLists(new ListNode[] {l2, null, l3}));
        System.out.println(mergeKLists(new ListNode[] {null, null, null}));
        System.out.println(mergeKLists(new ListNode[] {null, null, null, l1}));
